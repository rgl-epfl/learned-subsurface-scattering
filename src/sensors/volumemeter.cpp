...
class VolumeMeter : public Sensor {
public:
    VolumeMeter(const Properties &props) : Sensor(props) {
    ...
    VolumeMeter(Stream *stream, InstanceManager *manager)
...
MTS_IMPLEMENT_CLASS_S(VolumeMeter, false, Sensor)
MTS_EXPORT_PLUGIN(VolumeMeter, "Volume meter");
MTS_NAMESPACE_END
